                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="RecipeDetail?recipename=<%=name%>">
                                ...
                                <a href="Recipedetail.html" class="invisible">
                                    <img src="img/<%=image%>"  alt="" class="img-responsive">
                                </a>
                                <div class="text">
                                    <h3><a href="RecipeDetail.html"><%= name%></a></h3>
                                    <p class="buttons">
                                    ...
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="viewrecipe?RecipeId=<%=id1%>">
                                                <img src="img/<%=image1%>" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="viewrecipe?RecipeId=<%=id1%>">
